...
$(document).ready(function () {
    ...
    if (msieversion()) {    // IE 
        ...
        arr_text_p = ["61001- CRM", "61002- Credit Application", "61003- New Customer Set-up Form", "61004- Working Art Files", "61005- Die Drawing",
            "61006- File Assessment", "61007- Chemical Analysis", "61008- Fast Track", "61009- R & D Print Review (pop up warning to review)",
            "61010- Costing Review (pop up warning to review)", "61011- Quote Item Request Forms (see additional Tab)",
            "61012- Graphics Quote Request", "61013- Graphics Quote", "61014- Costing Templates (see additional Tab)",
            "61015- Blank Quote Templates (see additional Tab)", "61016- Sample Order Verification (pop up to Upload trip report or email)",
            "61017- Purchase Order", "61018- Sales Order", "61019- Credit Order Review (email) Template", "61020- Printed Eyespot/Dieline Review",
            "61021- Eyespot/Die Line Review Template", "61022- Graphic Checklist (see additional Tab)", "61023- Ink Draw Down", "61024- Graphics PDF",
            "61025- Graphics Approval Templates", "61026- Press Approval Waiver Or Approval", "61027- Graphics Artwork Invoice",
            "61028- Graphics Artwork Invoice to date", "61029- Item Request/MO Comment (see additional Tab)", "61030- R & D Print Checklist Review",
            "61031- Blue Sheet", "61032- High Profile CO Template", "61033- CO Template", "61034- Press Approval Template"

        ];


        arr_text = ["61002- Credit Application", "61003- New Customer Set-up Form", "61007- Chemical Analysis", "61011- Quote Item Request Forms (see additional Tab)",
            "61012- Graphics Quote Request", "61013- Graphics Quote", "61014- Costing Templates (see additional Tab)",
            "61015- Blank Quote Templates (see additional Tab)", "61018- Sales Order", "61019- Credit Order Review (email) Template",
            "61020- Printed Eyespot/Dieline Review", "61021- Eyespot/Die Line Review Template", "61022- Graphic Checklist (see additional Tab)",
            "61023- Ink Draw Down", "61025- Graphics Approval Templates", "61026- Press Approval Waiver Or Approval",
            "61029- Item Request/MO Comment (see additional Tab)", "61031- Blue Sheet",
            "61032- High Profile CO Template", "61033- CO Template", "61034- Press Approval Template"

        ];

        arr_link = ["61001- CRM", "61004- Working Art Files", "61005- Die Drawing", "61006- File Assessment", "61008- Fast Track",
            "61009- R & D Print Review (pop up warning to review)", "61010- Costing Review (pop up warning to review)",
            "61016- Sample Order Verification (pop up to Upload trip report or email)", "61017- Purchase Order", "61024- Graphics PDF",
