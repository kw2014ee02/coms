                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (msieversion()) {    // IE 
                            ...
                            table_mannual("61005- New Customer Set-up Form", "", -1);
                            f_name = "$New Customer Set-up Form.xls";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61006- Working Art Files", "", -1);

                            table_mannual("61007- File Assessment", "", -1);
                            //f_name = "$Temp_File.xlsm";
                            //table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61008- Printed Eyespot/Dieline Review", "", -1);
                            f_name = "$Printed Eyespot and-or Die Line Review Template.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61009- Die Drawing", "", -1);

                            table_mannual("61010- Graphics Quote Request", "", -1);
                            // f_name = "$Graphics Quote Request.xltm";
                            f_name = "$Graphics Quote Request.xlsm";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61011- Graphics Quote", "", -1);
                            f_name = "$Graphics Quote.xltm";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61012- Quote Item Request Forms", "", -1);
                            ...
                            table_mannual("61013- Costing Templates", "", -1);
                            ...
                            table_mannual("61014- Blank Quote Templates", "", -1);
                            ...
                            table_mannual("61015- Purchase Order", "", -1);

                            table_mannual("61016- Sales Order", "", -1);
                            ...
                            table_mannual("61017- Order Review Template", "", -1);
                            f_name = "$Order Review Template.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61018- Eyespot/Die Line Review Template", "", -1);
                            f_name = "$Printed Eyespot and-or Die Line Review Template.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61019- Graphics Checklist", "", -1);
                            ...
                            table_mannual("61020- Graphics PDF", "", -1);

                            table_mannual("61021- Graphics Approval Templates", "", -1);
                            ...
                            table_mannual("61022- Press Approval Waiver", "", -1);
                            f_name = "$Press Approval Waiver.DOC";
                            table_mannual(f_name, get_path(f_name, data), -1);


                            table_mannual("61023- Graphics Artwork Invoice", "", -1);
                            //  f_name = "$Graphics Artwork Invoice.xltm";
                            //  table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61024- Graphics Artwork Invoice to date", "", -1);
                            //  f_name = "$Graphics Artwork Invoice to date.xltm";
                            //    table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61025- Item Request/MO Comment", "", -1);
                            ...
                            table_mannual("61026- Print Checklist", "", -1);
                            f_name = "$Print Tech signoff.docx";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61027- Blue Sheet", "", -1);
                            f_name = "$Pouchstock Spec Sheet LC7 Copy V2.0.xlsx";
                            table_mannual(f_name, get_path(f_name, data), -1);
                            f_name = "$Rollstock Spec Sheet LC7 Copy V2.0.xlsx";
                            table_mannual(f_name, get_path(f_name, data), -1);

                            table_mannual("61028- High Profile CO Template", "", -1);
                            f_name = "$CO Template - High Profile.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);


                            table_mannual("61029- CO Template", "", -1);
                            f_name = "$CO Template.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);


                            table_mannual("61030- Press Approval Template", "", -1);
