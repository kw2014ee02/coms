    ...
    $("#myButton_jsonp").click(function () {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                var table = $("#tbl");
                table.empty();
                table.append('<tr><th></th><th>序列号23</th><th>ID</th><th>NAME</th><th>EMAIL</th></tr>');
                /*
                 $.each(data, function (index_array, element_array) {
                 alert(element_array);
                 $.each(element_array, function (a, b) {
                 alert(a);
                 ...
                 */
                $.each(data, function (k, v) {
                    //   alert(element_array.ID);
                    htmlStr += k + ": " + "ID is->" + v.ID + ' ' + v.NAME + ' ' + v.EMAIL + '<br />';
                    table.append('<tr><td></td><td>' + v.ID + '</td>' + '<td>' + v.NAME + '</td>' + '<td>' + v.EMAIL + '</td></tr>');
...
// var tbl = document.createElement('table');
    ...
    var orderArrayHeader = ["", "User_id", "name", "email"];
...
//alert("dd");
            ...
            cell1.innerHTML = v_object.ID;
            cell2.innerHTML = v_object.NAME;
            cell3.innerHTML = v_object.EMAIL;
            //  });
