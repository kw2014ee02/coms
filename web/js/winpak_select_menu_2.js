                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (msieversion()) {    // IE 
                            ...
                            table_mannual("61009- R & D Print Review (pop up warning to review)", "", -1);
                            table_mannual("61010- Costing Review (pop up warning to review)", "", -1);
                            table_mannual("61011- Quote Item Request Forms (see additional Tab)", "", -1);
                            ...
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61014- Costing Templates (see additional Tab)", "", -1);
                            ...
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61015- Blank Quote Templates (see additional Tab)", "", -1);
                            ...
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61016- Sample Order Verification (pop up to Upload trip report or email)", "", -1);
                            ...
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61021- Eyespot/Die Line Review Template", "", -1);
                            f_name = "$Printed Eyespot and-or Die Line Review Template.oft";
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61022- Graphic Checklist (see additional Tab)", "", -1);
                            ...
                            //    table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61029- Item Request/MO Comment (see additional Tab)", "", -1);
                            ...
                            table_mannual(f_name, get_path(f_name, data), -1);
                            table_mannual("61032- High Profile CO Template", "", -1);
