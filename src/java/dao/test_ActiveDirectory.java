 ...
 * @author w15rdknl
 */
public class test_ActiveDirectory {
        ...
        try {
            ...
            if (domainName != null) {
              ...
              //  NamingEnumeration<SearchResult> answer = context.search(toDC(domainName), "(& (userPrincipalName=" + principalName + ")(objectClass=user))", controls);
                ...
                String searchString = "(&(objectCategory=*)(sAMAccountName=" + username + "))";
                NamingEnumeration<SearchResult> answer = context.search(toDC(domainName), searchString, controls);
