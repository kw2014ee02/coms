 ...
 * @author w15rdknl
 */
public class auto_complete_order_number extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // term="61";
            ...
            order_number_dao ordernumberDao = new order_number_dao(driver, db_url, db_name, db_user, db_pwd, table_name);
            ArrayList<String> list = ordernumberDao.getOrderNumbers(callbackFunc, sql_stmt, term);
