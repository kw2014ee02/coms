    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            */
            ...
            signin user_signin = new signin(driver, db_url, db_name, db_user, db_pwd, table_name);

            String callbackFunc = request.getParameter("jsonp_test");
            //term_1="1001";
            //term_2="123456";
          //  sql_stmt=sql_stmt+" WHERE user_id = " + term_1 + " AND " + "PWD = " + "\'" + term_2 + "\'";
          term_1=term_1.toUpperCase();
          sql_stmt=sql_stmt+" WHERE UPPER(NAME) = " + "\'" + term_1 + "\'"+ " AND " + "PWD = " + "\'" + term_2 + "\'";
